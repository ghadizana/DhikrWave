package com.ghadiza.doadandzikirapp.model
...
object DataDzikrDoa {
    ...
    val listQauliyah: ArrayList<DzikrDoa>
        get() {
            val list = arrayListOf<DzikrDoa>()
            for (data in descQauliyah.indices) {
                val qauliyah = DzikrDoa (
                    descQauliyah[data],
                    lafazQauliyah[data],
    ...
    val listDzikr: ArrayList<DzikrDoa>
        get() {
            val list = arrayListOf<DzikrDoa>()
    ...
    val listDzikrPagi: ArrayList<DzikrDoa>
        get() {
            val list = arrayListOf<DzikrDoa>()
    ...
    val listDzikrPetang: ArrayList<DzikrDoa>
        get() {
            val list = arrayListOf<DzikrDoa>()
